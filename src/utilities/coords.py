...
def get_transform(tiff):
    ...
    src_ref.ImportFromWkt(src.GetProjection())

    # The target projection
    tgt_ref = osr.SpatialReference()
    tgt_ref.ImportFromEPSG(4326)  # this code gives us lat, long

    # Create the transform - this can be used repeatedly
    return osr.CoordinateTransformation(src_ref, tgt_ref)
...
def get_bridge_locations() -> gpd.array.GeometryArray:
    """
